...
const columns: GridColDef[] = [
  ...
  try{
    ...
    const request = await axios.get(`${import.meta.env.VITE_BASE_URL}/tor/inspection/sync/${import.meta.env.VITE_DLTB_COOP_ID}`,{
      headers :{
          Authorization : `Bearer ${import.meta.env.VITE_TOKEN}`
      }
  })
      ...
      if(response.messages[0].code === 0){
        ...
        if(JSON.stringify(response.response) !== JSON.stringify(tableRows)){
            ...
            response.response.map((data : any) =>{
              ...
              totalDiscrepancy = totalDiscrepancy + data.fieldData.total_discrepancy;

              console.log(data)

              totalPassengerCount = totalPassengerCount + data.fieldData.actual_count;
              
            })

            setTotalTicket(() =>totalDiscrepancy)
  
            setTotalBaggage(() => totalPassengerCount);
  
            setGrandTotal(() => totalPassengerCount)
...
return(
    ...
    <div className="relative block mt-10  p-12 bg-white border border-gray-200 rounded-lg shadow-lg"
        ...
        >
            <h1 className="mb-2 text-5xl  font-bold tracking-tight text-indigo-900">TOR INSPECTION</h1>
        </div>
...
<div className=" bg-white border border-gray-200 rounded-lg shadow-lg p-4">  
  <div className="flex items-center">
    ...
    <div className="flex-shrink-0 ml-3">
      ...
      <h3 className="text-base font-normal text-gray-500">{"TOTAL INSPECTION "}</h3>
    </div>
  </div>
</div>
...
<div className=" bg-white border border-gray-200 rounded-lg shadow-lg p-4">  
  <div className="flex items-center">
    ...
    <div className="flex-shrink-0 ml-3">
      ...
      <h3 className="text-base font-normal text-gray-500">{"TOTAL DISCREPANCY "}</h3>
    </div>
  </div>
</div>
...
<div className=" bg-white border border-gray-200 rounded-lg shadow-lg p-4">  
  <div className="flex items-center">
    ...
    <div className="flex-shrink-0 ml-3">
      ...
      <h3 className="text-base font-normal text-gray-500">{"TOTAL PASSENGER COUNT "}</h3>
    </div>
  </div>
</div>
